...
# TODO : Darren - we will need to consider target_compatible_with. We cannot do
#                 the same early return strategy as in CMake.
def gl_cpp_library(name, service_dirs = [], googleapis_deps = []):
    ...
    Args:
        ...
        deps: The googleapis-defined cc_grpc_library definitions.
    """
