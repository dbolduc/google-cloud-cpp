...
class AssuredWorkloadsServiceStub {
 public:
  ...
  virtual future<StatusOr<google::longrunning::Operation>> AsyncCreateWorkload(
      ...
      google::cloud::assuredworkloads::v1::CreateWorkloadRequest const& request) = 0;
  ...
  virtual StatusOr<google::cloud::assuredworkloads::v1::Workload> UpdateWorkload(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::UpdateWorkloadRequest const& request) = 0;

  virtual StatusOr<google::cloud::assuredworkloads::v1::RestrictAllowedResourcesResponse> RestrictAllowedResources(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::RestrictAllowedResourcesRequest const& request) = 0;

  virtual Status DeleteWorkload(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::DeleteWorkloadRequest const& request) = 0;

  virtual StatusOr<google::cloud::assuredworkloads::v1::Workload> GetWorkload(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::GetWorkloadRequest const& request) = 0;

  virtual StatusOr<google::cloud::assuredworkloads::v1::ListWorkloadsResponse> ListWorkloads(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::ListWorkloadsRequest const& request) = 0;

  virtual StatusOr<google::cloud::assuredworkloads::v1::ListViolationsResponse> ListViolations(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::ListViolationsRequest const& request) = 0;

  virtual StatusOr<google::cloud::assuredworkloads::v1::Violation> GetViolation(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::GetViolationRequest const& request) = 0;

  virtual StatusOr<google::cloud::assuredworkloads::v1::AcknowledgeViolationResponse> AcknowledgeViolation(
      grpc::ClientContext& context,
      Options const& options,
      google::cloud::assuredworkloads::v1::AcknowledgeViolationRequest const& request) = 0;
...
class DefaultAssuredWorkloadsServiceStub : public AssuredWorkloadsServiceStub {
 public:
  DefaultAssuredWorkloadsServiceStub(
      std::unique_ptr<google::cloud::assuredworkloads::v1::AssuredWorkloadsService::StubInterface> grpc_stub,
 ...
 private:
  std::unique_ptr<google::cloud::assuredworkloads::v1::AssuredWorkloadsService::StubInterface> grpc_stub_;
