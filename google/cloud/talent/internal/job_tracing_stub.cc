 ...
 public:
  ...
  future<StatusOr<google::longrunning::Operation>> AsyncBatchCreateJobs(
    ...
    return internal::CaptureReturn(
        ctx_ref, span,
        child_->AsyncBatchCreateJobs(cq, std::move(context), request));
  }
  ...
  future<StatusOr<google::longrunning::Operation>> AsyncGetOperation(
    ...
    return internal::CaptureReturn(
        ctx_ref, span,
        child_->AsyncGetOperation(cq, std::move(context), request));
  }
  ...
  future<Status> AsyncCancelOperation(
    ...
    return internal::CaptureReturn(
        ctx_ref, span,
        child_->AsyncCancelOperation(cq, std::move(context), request));
  }
