     ...
     opentelemetry::trace::SpanId parent_span_id) noexcept 
{
    ...
    // TODO : Darren : hardcode instead of using envvar
    // Get Project Id
    //const std::string project_id(getenv(kGCPEnvVar));
    const std::string project_id("dbolduc-test");
...
::google::devtools::cloudtrace::v2::Span_SpanKind MapSpanKind(opentelemetry::trace::SpanKind span_kind) {
    switch (span_kind) {
