...
#include "google/cloud/dialogflow_cx/v3/mocks/mock_transition_route_groups_connection.h"
...
/// @deprecated Use dialogflow_cx_v3_mocks::MockTransitionRouteGroupsConnection
/// directly.
using ::google::cloud::dialogflow_cx_v3_mocks::
