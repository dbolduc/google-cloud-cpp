...
#include "google/cloud/dialogflow_cx/v3/mocks/mock_flows_connection.h"
...
/// @deprecated Use dialogflow_cx_v3_mocks::MockFlowsConnection directly.
using ::google::cloud::dialogflow_cx_v3_mocks::MockFlowsConnection;
