...
#include "google/cloud/dialogflow_cx/v3/mocks/mock_test_cases_connection.h"
...
/// @deprecated Use dialogflow_cx_v3_mocks::MockTestCasesConnection directly.
using ::google::cloud::dialogflow_cx_v3_mocks::MockTestCasesConnection;
