...
#include "google/cloud/dialogflow_cx/v3/internal/versions_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/versions_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/versions_stub_factory.h"
...
std::shared_ptr<VersionsConnection> MakeVersionsConnection(
  ...
  options = dialogflow_cx_v3_internal::VersionsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultVersionsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeVersionsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::VersionsConnectionImpl>(
