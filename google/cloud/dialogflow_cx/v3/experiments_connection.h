...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_EXPERIMENTS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_EXPERIMENTS_CONNECTION_H
...
using ExperimentsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::ExperimentsRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockExperimentsConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::ExperimentsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_EXPERIMENTS_CONNECTION_H
