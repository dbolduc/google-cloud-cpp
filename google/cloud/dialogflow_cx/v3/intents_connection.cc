...
#include "google/cloud/dialogflow_cx/v3/internal/intents_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/intents_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/intents_stub_factory.h"
...
std::shared_ptr<IntentsConnection> MakeIntentsConnection(
  ...
  options = dialogflow_cx_v3_internal::IntentsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultIntentsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeIntentsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::IntentsConnectionImpl>(
