...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_VERSIONS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_VERSIONS_CONNECTION_H
...
using VersionsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::VersionsRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockVersionsConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::VersionsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_VERSIONS_CONNECTION_H
