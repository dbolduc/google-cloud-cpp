...
#include "google/cloud/dialogflow_cx/v3/internal/flows_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/flows_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/flows_stub_factory.h"
...
std::shared_ptr<FlowsConnection> MakeFlowsConnection(
  ...
  options = dialogflow_cx_v3_internal::FlowsDefaultOptions(location,
                                                           std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultFlowsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeFlowsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::FlowsConnectionImpl>(
