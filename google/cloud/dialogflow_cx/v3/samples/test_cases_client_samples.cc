...
#include "google/cloud/dialogflow_cx/v3/test_cases_client.h"
...
// main-dox-marker: dialogflow_cx_v3::TestCasesClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::TestCasesClient(
      google::cloud::dialogflow_cx_v3::MakeTestCasesConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::TestCasesClient(
        google::cloud::dialogflow_cx_v3::MakeTestCasesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
