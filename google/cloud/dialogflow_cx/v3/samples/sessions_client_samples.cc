...
#include "google/cloud/dialogflow_cx/v3/sessions_client.h"
...
// main-dox-marker: dialogflow_cx_v3::SessionsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::SessionsClient(
      google::cloud::dialogflow_cx_v3::MakeSessionsConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::SessionsClient(
        google::cloud::dialogflow_cx_v3::MakeSessionsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
