...
#include "google/cloud/dialogflow_cx/v3/security_settings_client.h"
...
// main-dox-marker: dialogflow_cx_v3::SecuritySettingsServiceClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::SecuritySettingsServiceClient(
      google::cloud::dialogflow_cx_v3::MakeSecuritySettingsServiceConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::SecuritySettingsServiceClient(
        google::cloud::dialogflow_cx_v3::MakeSecuritySettingsServiceConnection(
            options));
  }
  //! [with-service-account]
