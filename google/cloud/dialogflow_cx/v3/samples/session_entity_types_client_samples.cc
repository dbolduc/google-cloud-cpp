...
#include "google/cloud/dialogflow_cx/v3/session_entity_types_client.h"
...
// main-dox-marker: dialogflow_cx_v3::SessionEntityTypesClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::SessionEntityTypesClient(
      google::cloud::dialogflow_cx_v3::MakeSessionEntityTypesConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::SessionEntityTypesClient(
        google::cloud::dialogflow_cx_v3::MakeSessionEntityTypesConnection(
            options));
  }
  //! [with-service-account]
