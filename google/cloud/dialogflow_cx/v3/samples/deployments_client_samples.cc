...
#include "google/cloud/dialogflow_cx/v3/deployments_client.h"
...
// main-dox-marker: dialogflow_cx_v3::DeploymentsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::DeploymentsClient(
      google::cloud::dialogflow_cx_v3::MakeDeploymentsConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::DeploymentsClient(
        google::cloud::dialogflow_cx_v3::MakeDeploymentsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
