...
// main-dox-marker: dialogflow_cx_v3::EntityTypesClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::EntityTypesClient(
      google::cloud::dialogflow_cx_v3::MakeEntityTypesConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::EntityTypesClient(
        google::cloud::dialogflow_cx_v3::MakeEntityTypesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
