...
#include "google/cloud/dialogflow_cx/v3/transition_route_groups_client.h"
...
// main-dox-marker: dialogflow_cx_v3::TransitionRouteGroupsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_cx_v3::TransitionRouteGroupsClient(
      google::cloud::dialogflow_cx_v3::MakeTransitionRouteGroupsConnection(
          options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dialogflow_cx_v3::TransitionRouteGroupsClient(
        google::cloud::dialogflow_cx_v3::MakeTransitionRouteGroupsConnection(
            options));
  }
  //! [with-service-account]
