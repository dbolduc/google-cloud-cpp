...
#include "google/cloud/dialogflow_cx/v3/internal/entity_types_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/entity_types_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/entity_types_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/entity_types_tracing_connection.h"
...
std::shared_ptr<EntityTypesConnection> MakeEntityTypesConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 EntityTypesPolicyOptionList>(options,
                                                              __func__);
  options = dialogflow_cx_v3_internal::EntityTypesDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultEntityTypesStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeEntityTypesTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::EntityTypesConnectionImpl>(
