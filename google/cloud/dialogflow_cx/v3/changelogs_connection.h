...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_CHANGELOGS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_CHANGELOGS_CONNECTION_H
...
using ChangelogsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::ChangelogsRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockChangelogsConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::ChangelogsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_CHANGELOGS_CONNECTION_H
