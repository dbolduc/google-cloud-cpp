...
#include "google/cloud/dialogflow_cx/v3/internal/test_cases_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/test_cases_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/test_cases_stub_factory.h"
...
std::shared_ptr<TestCasesConnection> MakeTestCasesConnection(
  ...
  options = dialogflow_cx_v3_internal::TestCasesDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultTestCasesStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeTestCasesTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::TestCasesConnectionImpl>(
