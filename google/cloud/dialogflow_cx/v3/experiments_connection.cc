...
#include "google/cloud/dialogflow_cx/v3/internal/experiments_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/experiments_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/experiments_stub_factory.h"
...
std::shared_ptr<ExperimentsConnection> MakeExperimentsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 ExperimentsPolicyOptionList>(options,
                                                              __func__);
  options = dialogflow_cx_v3_internal::ExperimentsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultExperimentsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeExperimentsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::ExperimentsConnectionImpl>(
