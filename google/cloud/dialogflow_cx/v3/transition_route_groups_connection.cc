...
#include "google/cloud/dialogflow_cx/v3/internal/transition_route_groups_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/transition_route_groups_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/transition_route_groups_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/transition_route_groups_tracing_connection.h"
...
MakeTransitionRouteGroupsConnection(std::string const& location,
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      options, __func__);
  options = dialogflow_cx_v3_internal::TransitionRouteGroupsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultTransitionRouteGroupsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeTransitionRouteGroupsTracingConnection(
      std::make_shared<
          dialogflow_cx_v3_internal::TransitionRouteGroupsConnectionImpl>(
