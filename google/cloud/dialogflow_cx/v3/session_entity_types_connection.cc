...
#include "google/cloud/dialogflow_cx/v3/internal/session_entity_types_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/session_entity_types_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/session_entity_types_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/session_entity_types_tracing_connection.h"
...
std::shared_ptr<SessionEntityTypesConnection> MakeSessionEntityTypesConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 SessionEntityTypesPolicyOptionList>(options,
                                                                     __func__);
  options = dialogflow_cx_v3_internal::SessionEntityTypesDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultSessionEntityTypesStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeSessionEntityTypesTracingConnection(
      std::make_shared<
          dialogflow_cx_v3_internal::SessionEntityTypesConnectionImpl>(
