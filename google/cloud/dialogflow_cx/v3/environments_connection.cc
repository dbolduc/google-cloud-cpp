...
#include "google/cloud/dialogflow_cx/v3/internal/environments_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/environments_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/environments_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/environments_tracing_connection.h"
...
std::shared_ptr<EnvironmentsConnection> MakeEnvironmentsConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
                                 ...
                                 EnvironmentsPolicyOptionList>(options,
                                                               __func__);
  options = dialogflow_cx_v3_internal::EnvironmentsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultEnvironmentsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeEnvironmentsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::EnvironmentsConnectionImpl>(
