...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_FLOWS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_FLOWS_CONNECTION_H
...
using FlowsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::FlowsRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockFlowsConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::FlowsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_FLOWS_CONNECTION_H
