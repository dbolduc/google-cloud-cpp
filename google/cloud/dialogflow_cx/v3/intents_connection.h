...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTENTS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTENTS_CONNECTION_H
...
using IntentsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::IntentsRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockIntentsConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::IntentsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTENTS_CONNECTION_H
