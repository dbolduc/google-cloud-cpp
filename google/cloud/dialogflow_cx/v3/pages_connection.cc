...
#include "google/cloud/dialogflow_cx/v3/internal/pages_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/pages_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/pages_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/pages_tracing_connection.h"
...
std::shared_ptr<PagesConnection> MakePagesConnection(
  ...
  options = dialogflow_cx_v3_internal::PagesDefaultOptions(location,
                                                           std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultPagesStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakePagesTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::PagesConnectionImpl>(
