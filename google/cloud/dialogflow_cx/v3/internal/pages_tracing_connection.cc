...
PagesTracingConnection::ListPages(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::PagesConnection::ListPages");
...
PagesTracingConnection::GetPage(
  ...
  auto span = internal::MakeSpan("dialogflow_cx_v3::PagesConnection::GetPage");
  auto scope = opentelemetry::trace::Scope(span);
...
PagesTracingConnection::CreatePage(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::PagesConnection::CreatePage");
  auto scope = opentelemetry::trace::Scope(span);
...
PagesTracingConnection::UpdatePage(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::PagesConnection::UpdatePage");
  auto scope = opentelemetry::trace::Scope(span);
...
Status PagesTracingConnection::DeletePage(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::PagesConnection::DeletePage");
  auto scope = opentelemetry::trace::Scope(span);
