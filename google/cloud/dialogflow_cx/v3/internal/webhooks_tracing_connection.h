...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_WEBHOOKS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_WEBHOOKS_TRACING_CONNECTION_H
...
class WebhooksTracingConnection : public dialogflow_cx_v3::WebhooksConnection {
 public:
  ~WebhooksTracingConnection() override = default;

  explicit WebhooksTracingConnection(
      std::shared_ptr<dialogflow_cx_v3::WebhooksConnection> child);
 ...
 private:
  std::shared_ptr<dialogflow_cx_v3::WebhooksConnection> child_;
};
 ...
 */
std::shared_ptr<dialogflow_cx_v3::WebhooksConnection>
MakeWebhooksTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::WebhooksConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_WEBHOOKS_TRACING_CONNECTION_H
