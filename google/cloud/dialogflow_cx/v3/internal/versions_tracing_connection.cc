...
#include "google/cloud/dialogflow_cx/v3/internal/versions_tracing_connection.h"
...
VersionsTracingConnection::ListVersions(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::VersionsConnection::ListVersions");
...
VersionsTracingConnection::GetVersion(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::VersionsConnection::GetVersion");
  auto scope = opentelemetry::trace::Scope(span);
...
VersionsTracingConnection::UpdateVersion(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::VersionsConnection::UpdateVersion");
  auto scope = opentelemetry::trace::Scope(span);
...
Status VersionsTracingConnection::DeleteVersion(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::VersionsConnection::DeleteVersion");
  auto scope = opentelemetry::trace::Scope(span);
...
VersionsTracingConnection::CompareVersions(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::VersionsConnection::CompareVersions");
  auto scope = opentelemetry::trace::Scope(span);
