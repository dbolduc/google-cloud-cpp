...
#include "google/cloud/dialogflow_cx/v3/internal/test_cases_tracing_connection.h"
...
TestCasesTracingConnection::TestCasesTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::TestCasesConnection> child)
...
TestCasesTracingConnection::ListTestCases(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::ListTestCases");
...
Status TestCasesTracingConnection::BatchDeleteTestCases(
    google::cloud::dialogflow::cx::v3::BatchDeleteTestCasesRequest const&
        request) {
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::BatchDeleteTestCases");
  auto scope = opentelemetry::trace::Scope(span);
...
TestCasesTracingConnection::GetTestCase(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::TestCasesConnection::GetTestCase");
  auto scope = opentelemetry::trace::Scope(span);
...
TestCasesTracingConnection::CreateTestCase(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::CreateTestCase");
  auto scope = opentelemetry::trace::Scope(span);
...
TestCasesTracingConnection::UpdateTestCase(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::UpdateTestCase");
  auto scope = opentelemetry::trace::Scope(span);
...
TestCasesTracingConnection::CalculateCoverage(
    google::cloud::dialogflow::cx::v3::CalculateCoverageRequest const&
        request) {
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::CalculateCoverage");
  auto scope = opentelemetry::trace::Scope(span);
...
TestCasesTracingConnection::ListTestCaseResults(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::ListTestCaseResults");
  auto scope = opentelemetry::trace::Scope(span);
...
TestCasesTracingConnection::GetTestCaseResult(
    google::cloud::dialogflow::cx::v3::GetTestCaseResultRequest const&
        request) {
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::TestCasesConnection::GetTestCaseResult");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<dialogflow_cx_v3::TestCasesConnection>
MakeTestCasesTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::TestCasesConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
