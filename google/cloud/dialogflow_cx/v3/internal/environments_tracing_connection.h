...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_ENVIRONMENTS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_ENVIRONMENTS_TRACING_CONNECTION_H
...
class EnvironmentsTracingConnection
 ...
 public:
  ...
  explicit EnvironmentsTracingConnection(
      std::shared_ptr<dialogflow_cx_v3::EnvironmentsConnection> child);
 ...
 private:
  std::shared_ptr<dialogflow_cx_v3::EnvironmentsConnection> child_;
};
 ...
 */
std::shared_ptr<dialogflow_cx_v3::EnvironmentsConnection>
MakeEnvironmentsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::EnvironmentsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_ENVIRONMENTS_TRACING_CONNECTION_H
