...
EntityTypesTracingConnection::ListEntityTypes(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::EntityTypesConnection::ListEntityTypes");
...
EntityTypesTracingConnection::GetEntityType(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::EntityTypesConnection::GetEntityType");
  auto scope = opentelemetry::trace::Scope(span);
...
EntityTypesTracingConnection::CreateEntityType(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::EntityTypesConnection::CreateEntityType");
  auto scope = opentelemetry::trace::Scope(span);
...
EntityTypesTracingConnection::UpdateEntityType(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::EntityTypesConnection::UpdateEntityType");
  auto scope = opentelemetry::trace::Scope(span);
...
Status EntityTypesTracingConnection::DeleteEntityType(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::EntityTypesConnection::DeleteEntityType");
  auto scope = opentelemetry::trace::Scope(span);
