...
#include "google/cloud/dialogflow_cx/v3/internal/flows_tracing_connection.h"
...
FlowsTracingConnection::FlowsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::FlowsConnection> child)
...
FlowsTracingConnection::CreateFlow(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::FlowsConnection::CreateFlow");
...
Status FlowsTracingConnection::DeleteFlow(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::FlowsConnection::DeleteFlow");
  auto scope = opentelemetry::trace::Scope(span);
...
FlowsTracingConnection::ListFlows(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::FlowsConnection::ListFlows");
  auto scope = opentelemetry::trace::Scope(span);
...
FlowsTracingConnection::GetFlow(
  ...
  auto span = internal::MakeSpan("dialogflow_cx_v3::FlowsConnection::GetFlow");
  auto scope = opentelemetry::trace::Scope(span);
...
FlowsTracingConnection::UpdateFlow(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::FlowsConnection::UpdateFlow");
  auto scope = opentelemetry::trace::Scope(span);
...
FlowsTracingConnection::ValidateFlow(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::FlowsConnection::ValidateFlow");
  auto scope = opentelemetry::trace::Scope(span);
...
FlowsTracingConnection::GetFlowValidationResult(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::FlowsConnection::GetFlowValidationResult");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<dialogflow_cx_v3::FlowsConnection> MakeFlowsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::FlowsConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
