...
#include "google/cloud/dialogflow_cx/v3/internal/experiments_tracing_connection.h"
...
ExperimentsTracingConnection::ExperimentsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::ExperimentsConnection> child)
...
ExperimentsTracingConnection::ListExperiments(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::ListExperiments");
...
ExperimentsTracingConnection::GetExperiment(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::GetExperiment");
  auto scope = opentelemetry::trace::Scope(span);
...
ExperimentsTracingConnection::CreateExperiment(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::CreateExperiment");
  auto scope = opentelemetry::trace::Scope(span);
...
ExperimentsTracingConnection::UpdateExperiment(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::UpdateExperiment");
  auto scope = opentelemetry::trace::Scope(span);
...
Status ExperimentsTracingConnection::DeleteExperiment(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::DeleteExperiment");
  auto scope = opentelemetry::trace::Scope(span);
...
ExperimentsTracingConnection::StartExperiment(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::StartExperiment");
  auto scope = opentelemetry::trace::Scope(span);
...
ExperimentsTracingConnection::StopExperiment(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::ExperimentsConnection::StopExperiment");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<dialogflow_cx_v3::ExperimentsConnection>
MakeExperimentsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::ExperimentsConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
