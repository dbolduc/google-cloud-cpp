...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_VERSIONS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_VERSIONS_TRACING_CONNECTION_H
...
class VersionsTracingConnection : public dialogflow_cx_v3::VersionsConnection {
 public:
  ~VersionsTracingConnection() override = default;

  explicit VersionsTracingConnection(
      std::shared_ptr<dialogflow_cx_v3::VersionsConnection> child);
 ...
 private:
  std::shared_ptr<dialogflow_cx_v3::VersionsConnection> child_;
};
 ...
 */
std::shared_ptr<dialogflow_cx_v3::VersionsConnection>
MakeVersionsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::VersionsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_VERSIONS_TRACING_CONNECTION_H
