...
#include "google/cloud/dialogflow_cx/v3/internal/intents_tracing_connection.h"
...
IntentsTracingConnection::ListIntents(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::IntentsConnection::ListIntents");
...
IntentsTracingConnection::GetIntent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::IntentsConnection::GetIntent");
  auto scope = opentelemetry::trace::Scope(span);
...
IntentsTracingConnection::CreateIntent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::IntentsConnection::CreateIntent");
  auto scope = opentelemetry::trace::Scope(span);
...
IntentsTracingConnection::UpdateIntent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::IntentsConnection::UpdateIntent");
  auto scope = opentelemetry::trace::Scope(span);
...
Status IntentsTracingConnection::DeleteIntent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::IntentsConnection::DeleteIntent");
  auto scope = opentelemetry::trace::Scope(span);
