...
#include "google/cloud/dialogflow_cx/v3/internal/agents_tracing_connection.h"
...
AgentsTracingConnection::AgentsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::AgentsConnection> child)
...
AgentsTracingConnection::ListAgents(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::AgentsConnection::ListAgents");
...
AgentsTracingConnection::GetAgent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::AgentsConnection::GetAgent");
  auto scope = opentelemetry::trace::Scope(span);
...
AgentsTracingConnection::CreateAgent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::AgentsConnection::CreateAgent");
  auto scope = opentelemetry::trace::Scope(span);
...
AgentsTracingConnection::UpdateAgent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::AgentsConnection::UpdateAgent");
  auto scope = opentelemetry::trace::Scope(span);
...
Status AgentsTracingConnection::DeleteAgent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::AgentsConnection::DeleteAgent");
  auto scope = opentelemetry::trace::Scope(span);
...
AgentsTracingConnection::ValidateAgent(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::AgentsConnection::ValidateAgent");
  auto scope = opentelemetry::trace::Scope(span);
...
AgentsTracingConnection::GetAgentValidationResult(
  ...
  auto span = internal::MakeSpan(
      "dialogflow_cx_v3::AgentsConnection::GetAgentValidationResult");
  auto scope = opentelemetry::trace::Scope(span);
...
std::shared_ptr<dialogflow_cx_v3::AgentsConnection> MakeAgentsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::AgentsConnection> conn) {
#ifdef GOOGLE_CLOUD_CPP_HAVE_OPENTELEMETRY
