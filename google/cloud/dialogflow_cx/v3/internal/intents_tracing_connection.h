...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_INTENTS_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_INTENTS_TRACING_CONNECTION_H
...
class IntentsTracingConnection : public dialogflow_cx_v3::IntentsConnection {
 public:
  ~IntentsTracingConnection() override = default;

  explicit IntentsTracingConnection(
      std::shared_ptr<dialogflow_cx_v3::IntentsConnection> child);
 ...
 private:
  std::shared_ptr<dialogflow_cx_v3::IntentsConnection> child_;
};
 ...
 */
std::shared_ptr<dialogflow_cx_v3::IntentsConnection>
MakeIntentsTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::IntentsConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_INTENTS_TRACING_CONNECTION_H
