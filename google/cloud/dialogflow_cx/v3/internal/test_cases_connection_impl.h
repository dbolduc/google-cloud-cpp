...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_TEST_CASES_CONNECTION_IMPL_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_TEST_CASES_CONNECTION_IMPL_H

#include "google/cloud/dialogflow_cx/v3/internal/test_cases_retry_traits.h"
#include "google/cloud/dialogflow_cx/v3/internal/test_cases_stub.h"
#include "google/cloud/dialogflow_cx/v3/test_cases_connection.h"
...
class TestCasesConnectionImpl : public dialogflow_cx_v3::TestCasesConnection {
 public:
  ~TestCasesConnectionImpl() override = default;

  TestCasesConnectionImpl(
      std::unique_ptr<google::cloud::BackgroundThreads> background,
      std::shared_ptr<dialogflow_cx_v3_internal::TestCasesStub> stub,
      Options options);
 ...
 private:
  std::unique_ptr<dialogflow_cx_v3::TestCasesRetryPolicy> retry_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<dialogflow_cx_v3::TestCasesRetryPolicyOption>()) {
      return options.get<dialogflow_cx_v3::TestCasesRetryPolicyOption>()
          ->clone();
    }
    return options_.get<dialogflow_cx_v3::TestCasesRetryPolicyOption>()
        ->clone();
  }

  std::unique_ptr<BackoffPolicy> backoff_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<dialogflow_cx_v3::TestCasesBackoffPolicyOption>()) {
      return options.get<dialogflow_cx_v3::TestCasesBackoffPolicyOption>()
          ->clone();
    }
    return options_.get<dialogflow_cx_v3::TestCasesBackoffPolicyOption>()
        ->clone();
  }

  std::unique_ptr<dialogflow_cx_v3::TestCasesConnectionIdempotencyPolicy>
  idempotency_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<
            dialogflow_cx_v3::TestCasesConnectionIdempotencyPolicyOption>()) {
      return options
          .get<dialogflow_cx_v3::TestCasesConnectionIdempotencyPolicyOption>()
          ->clone();
    }
    return options_
        .get<dialogflow_cx_v3::TestCasesConnectionIdempotencyPolicyOption>()
  ...
  std::unique_ptr<PollingPolicy> polling_policy() {
    auto const& options = internal::CurrentOptions();
    if (options.has<dialogflow_cx_v3::TestCasesPollingPolicyOption>()) {
      return options.get<dialogflow_cx_v3::TestCasesPollingPolicyOption>()
          ->clone();
    }
    return options_.get<dialogflow_cx_v3::TestCasesPollingPolicyOption>()
        ->clone();
  }

  std::unique_ptr<google::cloud::BackgroundThreads> background_;
  std::shared_ptr<dialogflow_cx_v3_internal::TestCasesStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_TEST_CASES_CONNECTION_IMPL_H
