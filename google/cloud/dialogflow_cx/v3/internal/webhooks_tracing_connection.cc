...
WebhooksTracingConnection::ListWebhooks(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::WebhooksConnection::ListWebhooks");
...
WebhooksTracingConnection::GetWebhook(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::WebhooksConnection::GetWebhook");
  auto scope = opentelemetry::trace::Scope(span);
...
WebhooksTracingConnection::CreateWebhook(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::WebhooksConnection::CreateWebhook");
  auto scope = opentelemetry::trace::Scope(span);
...
WebhooksTracingConnection::UpdateWebhook(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::WebhooksConnection::UpdateWebhook");
  auto scope = opentelemetry::trace::Scope(span);
...
Status WebhooksTracingConnection::DeleteWebhook(
  ...
  auto span =
      internal::MakeSpan("dialogflow_cx_v3::WebhooksConnection::DeleteWebhook");
  auto scope = opentelemetry::trace::Scope(span);
