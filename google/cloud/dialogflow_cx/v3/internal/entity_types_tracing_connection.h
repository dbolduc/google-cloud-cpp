...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_ENTITY_TYPES_TRACING_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_ENTITY_TYPES_TRACING_CONNECTION_H
...
class EntityTypesTracingConnection
 ...
 public:
  ...
  explicit EntityTypesTracingConnection(
      std::shared_ptr<dialogflow_cx_v3::EntityTypesConnection> child);
 ...
 private:
  std::shared_ptr<dialogflow_cx_v3::EntityTypesConnection> child_;
};
 ...
 */
std::shared_ptr<dialogflow_cx_v3::EntityTypesConnection>
MakeEntityTypesTracingConnection(
    std::shared_ptr<dialogflow_cx_v3::EntityTypesConnection> conn);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_INTERNAL_ENTITY_TYPES_TRACING_CONNECTION_H
