...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_TEST_CASES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_TEST_CASES_CONNECTION_H
...
using TestCasesRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::TestCasesRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockTestCasesConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::TestCasesPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_TEST_CASES_CONNECTION_H
