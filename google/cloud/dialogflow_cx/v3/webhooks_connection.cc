...
#include "google/cloud/dialogflow_cx/v3/internal/webhooks_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/webhooks_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/webhooks_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/webhooks_tracing_connection.h"
...
std::shared_ptr<WebhooksConnection> MakeWebhooksConnection(
  ...
  options = dialogflow_cx_v3_internal::WebhooksDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultWebhooksStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeWebhooksTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::WebhooksConnectionImpl>(
