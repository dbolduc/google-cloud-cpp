...
#include "google/cloud/dialogflow_cx/v3/internal/agents_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/agents_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/agents_stub_factory.h"
...
std::shared_ptr<AgentsConnection> MakeAgentsConnection(
  ...
  options = dialogflow_cx_v3_internal::AgentsDefaultOptions(location,
                                                            std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultAgentsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeAgentsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::AgentsConnectionImpl>(
