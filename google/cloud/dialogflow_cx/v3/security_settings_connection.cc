...
#include "google/cloud/dialogflow_cx/v3/internal/security_settings_connection_impl.h"
#include "google/cloud/dialogflow_cx/v3/internal/security_settings_option_defaults.h"
#include "google/cloud/dialogflow_cx/v3/internal/security_settings_stub_factory.h"
#include "google/cloud/dialogflow_cx/v3/internal/security_settings_tracing_connection.h"
...
MakeSecuritySettingsServiceConnection(std::string const& location,
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      options, __func__);
  options = dialogflow_cx_v3_internal::SecuritySettingsServiceDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub =
      dialogflow_cx_v3_internal::CreateDefaultSecuritySettingsServiceStub(
          background->cq(), options);
  return dialogflow_cx_v3_internal::
      MakeSecuritySettingsServiceTracingConnection(
          std::make_shared<
              dialogflow_cx_v3_internal::SecuritySettingsServiceConnectionImpl>(
