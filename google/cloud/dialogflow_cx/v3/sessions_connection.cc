...
#include "google/cloud/dialogflow_cx/v3/internal/sessions_stub_factory.h"
...
std::shared_ptr<SessionsConnection> MakeSessionsConnection(
  ...
  options = dialogflow_cx_v3_internal::SessionsDefaultOptions(
      location, std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto stub = dialogflow_cx_v3_internal::CreateDefaultSessionsStub(
      background->cq(), options);
  return dialogflow_cx_v3_internal::MakeSessionsTracingConnection(
      std::make_shared<dialogflow_cx_v3_internal::SessionsConnectionImpl>(
