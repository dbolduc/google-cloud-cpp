...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_AGENTS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_AGENTS_CONNECTION_H
...
using AgentsRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::AgentsRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockAgentsConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::AgentsPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_AGENTS_CONNECTION_H
