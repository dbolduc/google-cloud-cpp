...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_WEBHOOKS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_WEBHOOKS_CONNECTION_H
...
using WebhooksRetryPolicy = ::google::cloud::internal::TraitBasedRetryPolicy<
    dialogflow_cx_v3_internal::WebhooksRetryTraits>;
 ...
 *
 * For mocking, see `dialogflow_cx_v3_mocks::MockWebhooksConnection`.
 */
 ...
 * - `google::cloud::dialogflow_cx_v3::WebhooksPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_V3_WEBHOOKS_CONNECTION_H
