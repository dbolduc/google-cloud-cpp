...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_INTERNAL_DARREN_APPLIER_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_INTERNAL_DARREN_APPLIER_H
...
class AsyncRetryBulkApply
 ...
 private:
  AsyncRetryBulkApply(CompletionQueue cq, std::shared_ptr<BigtableStub> stub,
                      std::unique_ptr<DataRetryPolicy> retry_policy,
                      std::unique_ptr<BackoffPolicy> backoff_policy,
                      bigtable::IdempotentMutationPolicy& idempotent_policy,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGTABLE_INTERNAL_DARREN_APPLIER_H
