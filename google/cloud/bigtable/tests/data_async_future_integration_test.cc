...
TEST_F(DataIntegrationTestClientOnly, TableAsyncApply) {
  auto table = GetTable();
...
TEST_P(DataIntegrationTest, TableAsyncBulkApply) {
...
TEST_P(DataIntegrationTest, TableAsyncReadRowsAllRows) {
  auto table = GetTable(GetParam());
