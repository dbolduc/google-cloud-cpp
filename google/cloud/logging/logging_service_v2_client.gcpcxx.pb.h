...
class LoggingServiceV2Client {
 public:
   ...
   * @return
   * [::google::logging::v2::WriteLogEntriesResponse](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L243)
   */
   ...
   *
   * @param request
   * [::google::logging::v2::DeleteLogRequest](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L140)
   */
   ...
   *
   * @param request
   * [::google::logging::v2::WriteLogEntriesRequest](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L162)
   * @return
   * [::google::logging::v2::WriteLogEntriesResponse](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L243)
   */
  StatusOr<::google::logging::v2::WriteLogEntriesResponse> WriteLogEntries(
   ...
   *
   * @param request
   * [::google::logging::v2::ListLogEntriesRequest](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L257)
   */
  StreamRange<::google::logging::v2::LogEntry> ListLogEntries(
   ...
   *
   * @param request
   * [::google::logging::v2::ListMonitoredResourceDescriptorsRequest](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L331)
   */
   ...
   *
   * @param request
   * [::google::logging::v2::ListLogsRequest](https://github.com/googleapis/googleapis/blob/spanner_request_options/google/logging/v2/logging.proto#L356)
   */
