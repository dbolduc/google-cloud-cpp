...
DefaultStoragePoolsRestStub::AggregatedListStoragePools(
  ...
  return rest_internal::Get<
      google::cloud::cpp::compute::v1::StoragePoolAggregatedList>(
            ...
            rest_internal::Delete<google::cloud::cpp::compute::v1::Operation>(
                *service, *rest_context, request, false,
                absl::StrCat("/", "compute", "/",
                             ...
                             "zones", "/", request.zone(), "/", "storagePools",
...
DefaultStoragePoolsRestStub::GetStoragePool(
  ...
  // param_field_name: storage_pool
  std::vector<std::pair<std::string, std::string>> params;
  // DEBUG : Skipping known field name: project
  // DEBUG : Skipping known field name: storage_pool
  ...
  return rest_internal::Get<google::cloud::cpp::compute::v1::Policy>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/",
                   rest_internal::DetermineApiVersion("v1", options), "/",
                   "projects", "/", request.project(), "/", "zones", "/",
                   request.zone(), "/", "storagePools", "/", request.resource(),
                   "/", "getIamPolicy"),
      ...
      [](auto p, auto service, auto request, auto rest_context, auto options) {
        p.set_value(
            rest_internal::Post<google::cloud::cpp::compute::v1::Operation>(
                *service, *rest_context, request.storage_pool_resource(), false,
                absl::StrCat("/", "compute", "/",
                             rest_internal::DetermineApiVersion("v1", *options),
                             "/", "projects", "/", request.project(), "/",
                             "zones", "/", request.zone(), "/", "storagePools"),
...
DefaultStoragePoolsRestStub::ListDisks(
  ...
  return rest_internal::Get<
      google::cloud::cpp::compute::v1::StoragePoolListDisks>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "compute", "/",
                   rest_internal::DetermineApiVersion("v1", options), "/",
                   "projects", "/", request.project(), "/", "zones", "/",
                   request.zone(), "/", "storagePools", "/",
                   request.storage_pool(), "/", "listDisks"),
      rest_internal::TrimEmptyQueryParameters(
          {std::make_pair("filter", request.filter()),
           std::make_pair("max_results", std::to_string(request.max_results())),
           std::make_pair("order_by", request.order_by()),
...
future<Status> DefaultStoragePoolsRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
