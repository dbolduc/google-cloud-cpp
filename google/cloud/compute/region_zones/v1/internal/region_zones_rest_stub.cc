...
DefaultRegionZonesRestStub::DefaultRegionZonesRestStub(Options options)
    : service_(rest_internal::MakePooledRestClient(
          options.get<EndpointOption>(), options)),
      options_(std::move(options)) {}

DefaultRegionZonesRestStub::DefaultRegionZonesRestStub(
    std::shared_ptr<rest_internal::RestClient> service, Options options)
    : service_(std::move(service)), options_(std::move(options)) {}

StatusOr<google::cloud::cpp::compute::v1::ZoneList>
DefaultRegionZonesRestStub::ListRegionZones(
