...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_STORAGE_V1_INTERNAL_BIGQUERY_WRITE_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_STORAGE_V1_INTERNAL_BIGQUERY_WRITE_TRACING_STUB_H
...
class BigQueryWriteTracingStub : public BigQueryWriteStub {
 public:
  ...
  explicit BigQueryWriteTracingStub(std::shared_ptr<BigQueryWriteStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_STORAGE_V1_INTERNAL_BIGQUERY_WRITE_TRACING_STUB_H
