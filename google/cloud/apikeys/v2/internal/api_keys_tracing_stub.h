...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIKEYS_V2_INTERNAL_API_KEYS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIKEYS_V2_INTERNAL_API_KEYS_TRACING_STUB_H
...
class ApiKeysTracingStub : public ApiKeysStub {
 public:
  ~ApiKeysTracingStub() override = default;

  explicit ApiKeysTracingStub(std::shared_ptr<ApiKeysStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIKEYS_V2_INTERNAL_API_KEYS_TRACING_STUB_H
