...
CreateDefaultFeatureOnlineStoreServiceStub(
  ...
  auto service_grpc_stub = google::cloud::aiplatform::v1::FeatureOnlineStoreService::NewStub(channel);
  std::shared_ptr<FeatureOnlineStoreServiceStub> stub =
    std::make_shared<DefaultFeatureOnlineStoreServiceStub>(std::move(service_grpc_stub));

  if (auth->RequiresConfigureContext()) {
    stub = std::make_shared<FeatureOnlineStoreServiceAuth>(
