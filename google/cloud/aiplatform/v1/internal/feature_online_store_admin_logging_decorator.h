...
class FeatureOnlineStoreAdminServiceLogging : public FeatureOnlineStoreAdminServiceStub {
 public:
  ~FeatureOnlineStoreAdminServiceLogging() override = default;
  FeatureOnlineStoreAdminServiceLogging(std::shared_ptr<FeatureOnlineStoreAdminServiceStub> child,
