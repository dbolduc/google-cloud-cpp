...
IndexEndpointServiceAuth::AsyncCreateIndexEndpoint(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncCreateIndexEndpoint(
...
StatusOr<google::cloud::aiplatform::v1::IndexEndpoint> IndexEndpointServiceAuth::GetIndexEndpoint(
    grpc::ClientContext& context,
...
StatusOr<google::cloud::aiplatform::v1::ListIndexEndpointsResponse> IndexEndpointServiceAuth::ListIndexEndpoints(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::aiplatform::v1::IndexEndpoint> IndexEndpointServiceAuth::UpdateIndexEndpoint(
    grpc::ClientContext& context,
    Options const& options,
...
IndexEndpointServiceAuth::AsyncDeleteIndexEndpoint(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeleteIndexEndpoint(
            cq, *std::move(context), std::move(options), request);
      });
}
...
IndexEndpointServiceAuth::AsyncDeployIndex(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncDeployIndex(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
IndexEndpointServiceAuth::DeployIndex(
      grpc::ClientContext& context,
      Options options,
      google::cloud::aiplatform::v1::DeployIndexRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
IndexEndpointServiceAuth::AsyncUndeployIndex(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUndeployIndex(
            cq, *std::move(context), std::move(options), request);
      });
}
...
IndexEndpointServiceAuth::AsyncMutateDeployedIndex(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncMutateDeployedIndex(
            cq, *std::move(context), std::move(options), request);
      });
}
