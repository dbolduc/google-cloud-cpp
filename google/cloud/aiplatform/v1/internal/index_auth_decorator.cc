...
StatusOr<google::cloud::aiplatform::v1::ListIndexesResponse> IndexServiceAuth::ListIndexes(
    grpc::ClientContext& context,
    Options const& options,
...
IndexServiceAuth::AsyncUpdateIndex(
  ...
  return auth_->AsyncConfigureContext(std::move(context)).then(
      [cq, child = child_, options = std::move(options), request](
        ...
        return child->AsyncUpdateIndex(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
IndexServiceAuth::UpdateIndex(
      grpc::ClientContext& context,
      Options options,
      google::cloud::aiplatform::v1::UpdateIndexRequest const& request) {
  auto status = auth_->ConfigureContext(context);
...
StatusOr<google::cloud::aiplatform::v1::UpsertDatapointsResponse> IndexServiceAuth::UpsertDatapoints(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::cloud::aiplatform::v1::RemoveDatapointsResponse> IndexServiceAuth::RemoveDatapoints(
    grpc::ClientContext& context,
    Options const& options,
