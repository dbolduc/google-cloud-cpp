...
// main-dox-marker:
// paymentgateway_issuerswitch_v1::IssuerSwitchTransactionsClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::paymentgateway_issuerswitch_v1::
      IssuerSwitchTransactionsClient(
          google::cloud::paymentgateway_issuerswitch_v1::
              MakeIssuerSwitchTransactionsConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::paymentgateway_issuerswitch_v1::
        IssuerSwitchTransactionsClient(
            google::cloud::paymentgateway_issuerswitch_v1::
                MakeIssuerSwitchTransactionsConnection(options));
  }
