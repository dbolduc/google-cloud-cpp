...
// main-dox-marker: paymentgateway_issuerswitch_v1::IssuerSwitchRulesClient
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client =
      google::cloud::paymentgateway_issuerswitch_v1::IssuerSwitchRulesClient(
          google::cloud::paymentgateway_issuerswitch_v1::
              MakeIssuerSwitchRulesConnection(options));
  //! [set-client-endpoint]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::paymentgateway_issuerswitch_v1::
        IssuerSwitchRulesClient(google::cloud::paymentgateway_issuerswitch_v1::
                                    MakeIssuerSwitchRulesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
