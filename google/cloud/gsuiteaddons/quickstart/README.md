# HOWTO: using the Google Workspace Add-ons API C++ client in your project

This directory contains small examples showing how to use the Google Workspace
Add-ons API C++ client library in your own project. These instructions assume
...
Like most Google Cloud Platform (GCP) services, Google Workspace Add-ons API
...
1. Install the dependencies with your favorite tools. As an example, if you use
   ...
   ```bash
   cd $HOME/vcpkg
   ./vcpkg install google-cloud-cpp[core,gsuiteaddons]
   ```
...
[quickstart-link]: https://developers.google.com/apps-script/add-ons/cats-quickstart
