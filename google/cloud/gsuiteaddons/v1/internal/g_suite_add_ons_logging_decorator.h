...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GSUITEADDONS_V1_INTERNAL_G_SUITE_ADD_ONS_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GSUITEADDONS_V1_INTERNAL_G_SUITE_ADD_ONS_LOGGING_DECORATOR_H
...
class GSuiteAddOnsLogging : public GSuiteAddOnsStub {
 public:
  ~GSuiteAddOnsLogging() override = default;
  GSuiteAddOnsLogging(std::shared_ptr<GSuiteAddOnsStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GSUITEADDONS_V1_INTERNAL_G_SUITE_ADD_ONS_LOGGING_DECORATOR_H
