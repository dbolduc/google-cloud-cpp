...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GSUITEADDONS_V1_INTERNAL_G_SUITE_ADD_ONS_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GSUITEADDONS_V1_INTERNAL_G_SUITE_ADD_ONS_STUB_H
...
class GSuiteAddOnsStub {
 public:
  ...
  virtual StatusOr<google::cloud::gsuiteaddons::v1::Deployment> GetDeployment(
      grpc::ClientContext& context,
      google::cloud::gsuiteaddons::v1::GetDeploymentRequest const& request) = 0;

  virtual StatusOr<google::cloud::gsuiteaddons::v1::ListDeploymentsResponse>
...
class DefaultGSuiteAddOnsStub : public GSuiteAddOnsStub {
 public:
  explicit DefaultGSuiteAddOnsStub(
      std::unique_ptr<
          google::cloud::gsuiteaddons::v1::GSuiteAddOns::StubInterface>
          grpc_stub)
  ...
  ListDeployments(grpc::ClientContext& client_context,
                  google::cloud::gsuiteaddons::v1::ListDeploymentsRequest const&
                      request) override;
 ...
 private:
  std::unique_ptr<google::cloud::gsuiteaddons::v1::GSuiteAddOns::StubInterface>
      grpc_stub_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_GSUITEADDONS_V1_INTERNAL_G_SUITE_ADD_ONS_STUB_H
