...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGATEWAY_V1_INTERNAL_API_GATEWAY_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGATEWAY_V1_INTERNAL_API_GATEWAY_TRACING_STUB_H
...
class ApiGatewayServiceTracingStub : public ApiGatewayServiceStub {
 public:
  ...
  explicit ApiGatewayServiceTracingStub(std::shared_ptr<ApiGatewayServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APIGATEWAY_V1_INTERNAL_API_GATEWAY_TRACING_STUB_H
