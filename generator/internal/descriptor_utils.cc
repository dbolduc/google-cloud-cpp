...
auto constexpr kContactCenterInsightsProto = R"""(
 to create a phrase matcher for. Format: `projects/<Project
 ID>/locations/<Location ID>` or `projects/<Project
 Number>/locations/<Location ID>`)""";

auto constexpr kContactCenterInsightsCpp = R"""(
...
ParameterCommentSubstitution substitutions[] = {
    ...
    // From contactcenterinsights/v1.
    {kContactCenterInsightsProto, kContactCenterInsightsCpp},

    // Dialogflow has a number of code quotes that are broken up over multiple
    // lines, and include angle brackets. Doxygen thinks these are unrecognized
    // HTML tags, unless the code quote occupies a single line.
